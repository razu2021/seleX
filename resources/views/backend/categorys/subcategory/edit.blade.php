                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="category_name" id="category_name" type="text" value="{{$data->category_name}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="category_title" id="category_title" type="text" value="{{$data->category_title}}">
                                ...
                                <div class="col-12 mb-1">
                                    ...
                                    <input class="form-control" name="category_desc" id="category_desc" type="text" value="{{$data->category_des}}">
                      ...
                      <div class="card">
                          <div class="card-body">
                            <div class="col-12">
                              ...
                              <input class="form-control" name="custom_url" id="custom_url" type="text" value="{{$data->custom_url}}">
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" name="meta_title" id="meta_title" type="text" value="{{$data->metaData->meta_title}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="meta_description">Meta Descriptions:</label>
                            <input class="form-control" name="meta_description" id="meta_description" type="text" value="{{$data->metaData->meta_description}}">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" name="meta_keywords" id="meta_keywords" type="hidden" value="{{$data->metaData->meta_keywords}}">
                            
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="meta_robots">Meta Robots:</label>
                            <input class="form-control" name="meta_robots" id="meta_robots" type="text" value="{{$data->metaData->meta_robots}}">
                           
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="canonical_url">Canonical Url:</label>
                            <input class="form-control" name="canonical_url" id="canonical_url" type="text" value="{{$data->metaData->canonical_url}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="hreflang_tags"> Url for Language :</label>
                            <input class="form-control" name="hreflang_tags" id="hreflang_tags" type="text" value="{{$data->metaData->hreflang_tags}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="structured_data">structured Data / schema:</label>
                            <input class="form-control" name="structured_data" id="structured_data" type="text" value="{{$data->metaData->structured_data}}">
                          </div>
                          {{-- end  --}}
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" name="og_title" id="og_title" type="text" value="{{$data->metaData->og_title}}">
                           
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="og_description-">Og Descriptions:</label>
                            <input class="form-control" name="og_description" id="og_description" type="text" value="{{$data->metaData->og_description}}">
                           
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="og_url">Og Url:</label>
                            <input class="form-control" name="og_url" id="og_url" type="text" value="{{$data->metaData->og_url}}">
                            
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="og_type">Og Type:</label>
                            <input class="form-control" name="og_type" id="og_type" type="text" value="{{$data->metaData->og_type}}">
                            
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="og_locale">Og Local Language :</label>
                            <input class="form-control" name="og_locale" id="og_locale" type="text" value="{{$data->metaData->og_locale}}">
                          </div>
                          {{-- end  --}}
                        </div>
                    </div>
                      ...
                      <div class="card mt-4">
                        <div class="card-body">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" name="twitter_card" id="twitter_card" type="text" value="{{$data->metaData->twitter_card}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="twitter_title">Twitter Title:</label>
                            <input class="form-control" name="twitter_title" id="twitter_title" type="text" value="{{$data->metaData->twitter_title}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="twitter_description">twitter_description :</label>
                            <input class="form-control" name="twitter_description" id="twitter_description-" type="text" value="{{$data->metaData->twitter_description}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="manufacturar-name">twitter site:</label>
                            <input class="form-control" name="twitter_site" id="twitter_site" type="text" value="{{$data->metaData->twitter_site}}">
                          </div>
                          {{-- end  --}}
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" name="whatsapp_title" id="whatsapp_title" type="text" value="{{$data->metaData->whatsapp_title}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="whatsapp_description">WhatsApp Descriptions :</label>
                            <input class="form-control" name="whatsapp_description" id="whatsapp_description" type="text" value="{{$data->metaData->whatsapp_description}}"> 
                          </div>
                          {{-- end  --}}
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body">
                          ...
                          <div class="col-12">
                            ...
                            <input class="form-control" name="pinterest_description" id="pinterest_description" type="text" value="{{$data->metaData->pinterest_description}}">
                          </div>
                          {{-- end  --}}
                          <div class="col-12">
                            <label class="form-label" for="pinterest_rich_pin">Pinterest Rich pin :</label>
                            <input class="form-control" name="pinterest_rich_pin" id="pinterest_rich_pin" type="text" value="{{$data->metaData->pinterest_rich_pin}}">
                          </div>
                          {{-- end --}}
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                          ...
                          <div class="col-12 mt-2 p-2">
                            @if(optional($data->metaData)->images && count($data->metaData->images) > 0)
                                @foreach($data->metaData->images as $image)
