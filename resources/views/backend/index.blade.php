                                    ...
                                    <table class="table table-dashboard mb-0 table-borderless fs-10 border-200">
                                        ...
                                        <tbody>
                                            <tr class="border-bottom border-200">
                                                <td>
                                                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{asset('contents/backend/assets')}}/assets/img/products/12.png" width="60" alt="" />
                                            ...
                                            <tr class="border-bottom border-200">
                                                <td>
                                                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{asset('contents/backend/assets')}}/assets/img/products/10.png" width="60" alt="" />
                                                        <div class="flex-1 ms-3">
                                            ...
                                            <tr class="border-bottom border-200">
                                                <td>
                                                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{asset('contents/backend/assets')}}/assets/img/products/11.png" width="60" alt="" />
                                                        <div class="flex-1 ms-3">
                                            ...
                                            <tr class="border-bottom border-200">
                                                <td>
                                                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{asset('contents/backend/assets')}}/assets/img/products/14.png" width="60" alt="" />
                                                        <div class="flex-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{asset('contents/backend/assets')}}/assets/img/products/13.png" width="60" alt="" />
                                                        <div class="flex-1 ms-3">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="{{asset('contents/backend/assets')}}/assets/img/products/5-thumb.png" alt="" /></div>
                                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                                        ...
                                        <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-tertiary border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="{{asset('contents/backend/assets')}}/assets/img/icons/cloud-download.svg" download="download"><img src="{{asset('contents/backend/assets')}}/assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
                                            <button
                                                class="btn btn-tertiary border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="{{asset('contents/backend/assets')}}/assets/img/icons/edit-alt.svg" alt="" width="15" /></button>
                                        </div>
                                    </div>
                                </div>
                                <hr class="text-200" />
                                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="{{asset('contents/backend/assets')}}/assets/img/products/3-thumb.png" alt="" /></div>
                                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                                ...
                                <hr class="text-200" />
                                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                                    <div class="file-thumbnail"><img class="img-fluid" src="{{asset('contents/backend/assets')}}/assets/img/icons/zip.png" alt="" /></div>
                                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                                ...
                                <hr class="text-200" />
                                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                                    <div class="file-thumbnail"><img class="border h-100 w-100 object-fit-cover rounded-2" src="{{asset('contents/backend/assets')}}/assets/img/products/2-thumb.png" alt="" /></div>
                                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                                ...
                                <hr class="text-200" />
                                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                                    <div class="file-thumbnail"><img class="img-fluid" src="{{asset('contents/backend/assets')}}/assets/img/icons/docs.png" alt="" /></div>
                                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                            ...
                            <div class="card-body py-2">
                                ...
                                <div class="d-flex align-items-center position-relative mb-3">
                                    <div class="avatar avatar-2xl status-offline">
                                        <img class="rounded-circle" src="{{asset('contents/backend/assets')}}/assets/img/team/4.jpg" alt="" />
                                    </div>
                                    <div class="flex-1 ms-3">
                                ...
                                <div class="d-flex align-items-center position-relative false">
                                    <div class="avatar avatar-2xl status-offline">
                                        <img class="rounded-circle" src="{{asset('contents/backend/assets')}}/assets/img/team/5.jpg" alt="" />
                                    </div>
                                    <div class="flex-1 ms-3">
