  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
    <div class="modal-content position-relative">
      ...
      <div class="modal-body p-0">
        ...
        <div class="p-4 pb-0">
            <input type="hidden" name="seo_id" value="{{$data->id}}">
            <input type="hidden" name="model_type" value="{{$data->model_type}}">
            <div class="max-w-xs mx-auto bg-white rounded-xl shadow-md p-4 text-center">
              <label for="file-upload" class="cursor-pointer flex flex-col items-center justify-center h-40 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100 transition">
        ...
        <div class="p-4 pb-0">
            <div class="p-4 pb-0">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" name="images" type="file" id="image" aria-describedby="image"
                  onchange="document.getElementById('preview_image').src = window.URL.createObjectURL(this.files[0])">
              </div>
              <div class="pt-4 pb-4">
                @if (!empty($image))
                  <img id="preview_image" src="{{asset('storage/uploads/seo/'.$image->image_name)}}" alt="image" height="80px">
                @else
                  <img src="{{ asset('uploads/avater.jpg') }}" alt="SEO Image" height="80px" width="auto" style="border: 1px solid #000">
                @endif
              </div>
