                ...
                <div class="col-lg-8 ">
                  <div class="sidebar_wrapper">
                    <div class="sidebar_card">
                      ...
                      @endforeach
                      <input class="form-control" name="id" id="id" type="hidden" value="{{$data->unique_id}}">
                      <input class="form-control" name="slug" id="slug" type="hidden" value="{{$data->slug}}">
                      <input class="form-control" name="model_type" id="model_type" type="hidden" value="{{$data->model_type}}">
