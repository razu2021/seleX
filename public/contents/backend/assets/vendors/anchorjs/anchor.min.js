...
! function(A, e) {
    ...
    return function(A) {
        ...
        this.options = A || {}, this.elements = [], u(this.options), this.add = function(A) {
            ...
            return e.innerHTML = A, A = e.value, this.options.truncate || u(this.options), A.trim().replace(/'/gi, "").replace(/[& +$,:;=?@"#{}|^~[`%!'<>\]./()*\\\n\t\b\v\u00A0]/g, "-").replace(/-{2,}/g, "-").substring(0, this.options.truncate).replace(/^-+|-+$/gm, "").toLowerCase()
